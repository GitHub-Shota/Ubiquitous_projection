...
int main()
{
    ...
    // 表示するウィンドウに名前を付ける
    cv::namedWindow("Level2.4_Tx", cv::WINDOW_NORMAL);
    // フルスクリーン表示
    // cv::setWindowProperty("Level2.4_Tx", cv::WND_PROP_FULLSCREEN, cv::WINDOW_FULLSCREEN);

    // マウスイベントの登録
    cv::setMouseCallback("Level2.4_Tx", draw_line);
